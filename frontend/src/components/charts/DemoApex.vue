<template>
	<apexchart ref="chart" width="100%" height="100%" v-if="ready" :type="type" :options="options" :series="series"
		:class="{ 'time-buttons': timeButtons }" :style="legendOffset && `--legend-offset:${legendOffset}px`"></apexchart>
</template>
