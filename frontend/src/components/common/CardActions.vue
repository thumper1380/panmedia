<template>
    <n-card class="flex h-full" :hoverable="hoverable" :size="isMobile() ? 'small' : 'medium'"
        :class="{ actionBoxTransparent }">
...
import { NCard, NDropdown, NScrollbar, NSpace, NButton } from "naive-ui"
