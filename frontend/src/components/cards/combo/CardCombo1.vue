        ...
        <div class="card-wrap flex flex-col justify-between">
            <div class="header flex">
                ...
                <div class="info grow">
                    ...
                    <div class="value">
                        <!-- <n-number-animation ref="numberAnimationInstRef" show-separator locale="en-EN" :from="0" :to="value"
                            :active="true" /> -->
...
import { NCard, NNumberAnimation, NTooltip } from "naive-ui"
...
const props = withDefaults(
    ...
    {
        type: "area", chartHeight: 80, chartPaddingTop: "0px", chartBarGradient: false, value: 0
    }
)
const { type, title, currency, chartColor, chartHeight, dataCount, chartPaddingTop, chartBarGradient, series, value } = toRefs(props)
...
const valueString = computed(() => {
    if (currency?.value) {
        ...
        return new Intl.NumberFormat("en-EN").format(currentValue.value ?? value.value)
    }
})

// const series = ref([
//     {
//         data: [[1705356000000.0, 1], [1705788000000.0, 5], [1705874400000.0, 2], [1705960800000.0, 1], [1706220000000.0, 1], [1706392800000.0, 3], [1706479200000.0, 1]]
//     }
// ])

// compute total values
// const TotalValues = computed(() => {
//     return series.value[0].data.map((i: any) => i[1]).reduce((a: any, c: any) => a + c, 0)
// })
...
.n-card {
    ...
    .card-wrap {
        ...
        .chart-box {
            ...
            &.type-bar {
                padding: v-bind(chartPaddingTop) calc(var(--n-padding-left) - 6px) 14px calc(var(--n-padding-left) - 9px);
            }
        }
    }
}
