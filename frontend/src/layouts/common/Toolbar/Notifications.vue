<template>
	<!-- <n-popover :show-arrow="true" placement="bottom" content-style="padding:0" style="max-width: 280px">
		<template #trigger>
	...
	<n-button text @click="showDrawer = true"> <n-badge :show="hasNotifications" dot :color="primaryColor"
...
onMounted(async () => {
	...
	// 			type: "news",
	// 			title: "Good news",
	// 			description: "HI!, I'm a new notification",
	// 			read: false,
	// 			date: "Today",
	// 			action: () => {
