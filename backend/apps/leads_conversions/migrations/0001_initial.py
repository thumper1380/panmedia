    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', polymorphic_tree.models.PolymorphicTreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='leads_conversions.payouts')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(editable=False)),
                ('parent', polymorphic_tree.models.PolymorphicTreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='leads_conversions.revenues')),
                ('polymorphic_ctype', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_%(app_label)s.%(class)s_set+', to='contenttypes.contenttype')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='PayoutAdvertiserFolder',
            fields=[
                ('payouts_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='leads_conversions.payouts')),
            ],
            options={
            ...
            bases=('leads_conversions.payouts', models.Model),
        ),
        migrations.CreateModel(
            name='PayoutAffiliateFolder',
            fields=[
                ('payouts_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='leads_conversions.payouts')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='USD', max_digits=14)),
            ],
            options={
                'verbose_name': 'Payout',
                'verbose_name_plural': 'Payouts',
            },
            bases=(apps.utils.folders.TargetFolder, 'leads_conversions.payouts'),
        ),
        migrations.CreateModel(
            name='RevenueAdvertiserFolder',
            fields=[
                ('revenues_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='leads_conversions.revenues')),
            ],
            options={
                'verbose_name': 'Advertiser Folder',
                'verbose_name_plural': 'Advertiser Folders',
            ...
            bases=('leads_conversions.revenues', models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Revenue Folder',
                'verbose_name_plural': 'Revenue Folders',
            },
            bases=(apps.utils.folders.TargetFolder, 'leads_conversions.revenues'),
        ),
        migrations.CreateModel(
            name='RevenueAffiliateFolder',
            fields=[
                ('revenues_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='leads_conversions.revenues')),
